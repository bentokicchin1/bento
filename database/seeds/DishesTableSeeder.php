...
class DishesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ['dish_type_id' => 1, 'name' => 'Aloo', 'code' => 'ALOO', 'price' => 30, 'description' => '', 'image' => ''],
            ['dish_type_id' => 1, 'name' => 'Bhendi', 'code' => 'BHENDI', 'price' => 40, 'description' => '', 'image' => ''],
            ['dish_type_id' => 1, 'name' => 'Tomato', 'code' => 'TOMATO', 'price' => 25, 'description' => '', 'image' => ''],
            ['dish_type_id' => 1, 'name' => 'Palak Paneer', 'code' => 'PALAK_PANEER', 'price' => 60, 'description' => '', 'image' => ''],
            ['dish_type_id' => 2, 'name' => 'Chapati', 'code' => 'CHAPATI', 'price' => 5, 'description' => '', 'image' => ''],
            ['dish_type_id' => 2, 'name' => 'Roti', 'code' => 'ROTI', 'price' => 7, 'description' => '', 'image' => ''],
            ['dish_type_id' => 2, 'name' => 'Bhakri', 'code' => 'BHAKRI', 'price' => 10, 'description' => '', 'image' => ''],
            ['dish_type_id' => 3, 'name' => 'Plain Rice', 'code' => 'PLAINRICE', 'price' => 20, 'description' => '', 'image' => ''],
            ['dish_type_id' => 3, 'name' => 'Jira Rice', 'code' => 'JIRARICE', 'price' => 25, 'description' => '', 'image' => ''],
            ['dish_type_id' => 3, 'name' => 'Pulav', 'code' => 'PULAV', 'price' => 30, 'description' => '', 'image' => ''],
            ['dish_type_id' => 4, 'name' => 'Plain Dal', 'code' => 'P_DAL', 'price' => 20, 'description' => '', 'image' => ''],
            ['dish_type_id' => 4, 'name' => 'Dal Tadka', 'code' => 'T_DAL', 'price' => 25, 'description' => '', 'image' => ''],
            ['dish_type_id' => 4, 'name' => 'Dal Fry', 'code' => 'F_DAL', 'price' => 40, 'description' => '', 'image' => ''],
            ['dish_type_id' => 5, 'name' => 'Salad', 'code' => 'SALAD', 'price' => 10, 'description' => '', 'image' => ''],
            ['dish_type_id' => 5, 'name' => 'Butter Milk', 'code' => 'B_MILK', 'price' => 10, 'description' => '', 'image' => ''],
        ];
