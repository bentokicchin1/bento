                                                        ...
                                                        @if (is_array($order['orderDishes']))
                                                            ...
                                                            <ul>
                                                                @foreach($order['orderDishes'] as $orderItems)
                                                                    <li style="line-height: 1.5;font-size: 12px">{{$orderItems['quantity']}} {{$orderItems['dishName']}} - {{$orderItems['total_price']}}Rs.</li>
                                                                    @foreach($orderItems as $otherDishes)
                                                                        @if(is_array($otherDishes))
                                                                            <li style="line-height: 1.5;font-size: 12px">{{$otherDishes['quantity']}} {{$otherDishes['dishName']}} - {{$otherDishes['total_price']}}Rs.</li>
                                                                        @endif
                                                                    @endforeach
                                                                @endforeach
                                                            </ul>
